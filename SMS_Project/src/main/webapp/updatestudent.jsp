...
<body>
  ...
  <div class="form-container">
    ...
    <form action="UpdateStudentFinalController" method="post">
      ...
      <div class="form-group">
        <label>Age</label>
        <input type="text" name="age" value="<%= s.getAge() %>" required />
      </div>

      <div class="form-group">
        <label>Class</label>
        <input type="text" name="studentClass" value="<%= s.getStudentClass() %>" required />
      </div>
      ...
      <a href="ViewStudentController" class="back-btn">Back to Student Records</a>
    </form>
  </div>
